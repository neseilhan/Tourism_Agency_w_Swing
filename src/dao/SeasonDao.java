...
public class SeasonDao {
    ...
    public ArrayList<Season> getByListHotelId(int hotelId) { //get season list by hotelId.
        return this.selectByQuery("SELECT * FROM public.season WHERE season_hotel_id = " + hotelId);
    }
